...
/*!************************!*\
  !*** ./src/TownMap.ts ***!
  \************************/
/*! exports provided: TowmMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"TowmMap\", function() { return TowmMap; });\n// 町データ管理クラス。画像のロード、マップ画面の描画も担当する。\r\nvar TowmMap = /** @class */ (function () {\r\n    // 画像の読み込み、拡大マップ表示用の裏画面の準備、人々の初期化を行う。\r\n    function TowmMap() {\r\n    }\r\n    // 通路情報が描かれた縮小マップ画像を返します。\r\n    TowmMap.prototype.getStreetImage = function () { };\r\n    // マップ表示用の裏画面を返します。この画面には人々が描画されています。\r\n    TowmMap.prototype.getMapImage = function () { };\r\n    // マップを描画します。マップ画面は「背景」「人々」「前景」の3つのレイヤーで構成されます。\r\n    TowmMap.prototype.drawMapImage = function () { };\r\n    // 時間を進め、町の人々を移動させます。移動後に人々はY座標でソートされます。\r\n    // また、主人公が中心に来るように、マップのスクロール座標も更新します。\r\n    TowmMap.prototype.update = function () { };\r\n    // 主人公を返します。\r\n    TowmMap.prototype.getMainPeople = function () { };\r\n    // 人々のリストを返します。\r\n    TowmMap.prototype.getPeopleList = function () { };\r\n    // マップのスクロール座標を返します。\r\n    TowmMap.prototype.getScreenPos = function () { };\r\n    // 現在のフレームカウントを返します。\r\n    TowmMap.prototype.getCounter = function () { };\r\n    // テスト用\r\n    TowmMap.prototype.inca = function (a) { return a + 1; };\r\n    return TowmMap;\r\n}());\r\n\r\n\n\n//# sourceURL=webpack:///./src/TownMap.ts?");
